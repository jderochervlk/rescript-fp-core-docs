...
function LandingPageLayout$QuickInstall$Instructions(Props) {
  return React.createElement("div", {
              className: "w-full max-w-[400px]"
                ...
                }, copyBox("npm install rescript")), React.createElement("div", {
                  className: "captions x text-gray-40 mb-2 mt-2"
                }, "Or generate a new project from the official template with npx:"), React.createElement("div", {
                  className: "w-full space-y-2"
